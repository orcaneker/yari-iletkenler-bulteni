...
AYARLAR = {
    ...
    "max_tokens_yazim": 32000,       # katmanlı bülten + derin detay için gerekli
    "derin_olay_sayisi": 20,         # tam metinle Sonnet'e giden olay (manşet+öne çıkan havuzu)
    "toplam_olay_sayisi": 48,        # geri kalanı radar adayı (sadece başlık+link)

    # Exa
    "exa_sonuc_sayisi": 20,          # sorgu başına
    "exa_metin_karakter": 2500,      # Exa'dan çekilen makale metni (maliyet dengeli)
    "exa_triyaj_karakter": 700,      # triyaja giden kısa parça (ucuz)
    "exa_yazim_karakter": 2400,      # Sonnet'e giden metin — DETAY BURADAN GELİR
    "exa_tip": "auto",
